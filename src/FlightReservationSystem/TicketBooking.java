...
public abstract class TicketBooking {//using abstract keyword as the TicketBooking cannot be instantiated.
    ...
    public static void printTicketDetails(TicketBooking ticketBooking) {//function printing pnr of child classes in main.
        System.out.println(ticketBooking.getPNR());
    }
